# Script de Automação Portainer CE (com verificações de existência)
...
if (-not (Get-Command "docker" -ErrorAction SilentlyContinue)) {
    ...
    Write-Host "Faça o download em: https://www.docker.com/products/docker-desktop/" -ForegroundColor Yellow
    exit
}
